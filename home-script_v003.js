...
// Fade In Paragraph 02
var fadeInParagraph02 = anime.timeline({
  targets: '.fu-p-02',
  translateY: ["-100%",0],
  translateZ: 0,
  opacity: [0,1],
...
// Fade In Paragraph 03
var fadeInParagraph03 = anime.timeline({
  targets: '.fu-p-03',
  translateY: ["-100%",0],
  translateZ: 0,
  opacity: [0,1],
...
// Fade In Paragraph 04
var fadeInParagraph04 = anime.timeline({
  targets: '.fu-p-04',
  translateY: ["-100%",0],
  translateZ: 0,
  opacity: [0,1],
...
// Fade Out Paragraph 02
var fadeOutParagraph02 = anime.timeline({
  targets: '.fu-p-02',
  translateY: [0,"-100%"],
  opacity: [1,0],
  easing: "easeOutExpo",
...
// Fade Out Paragraph 03
var fadeOutParagraph03 = anime.timeline({
  targets: '.fu-p-03',
  translateY: [0,"-100%"],
  opacity: [1,0],
  easing: "easeOutExpo",
...
// Fade Out Paragraph 04
var fadeOutParagraph04 = anime.timeline({
  targets: '.fu-p-04',
  translateY: [0,"-100%"],
  opacity: [1,0],
  easing: "easeOutExpo",
...
//////// SHRINK PARAGRAPHS WRAPPER ////////

// Fade Out Paragraph 01
var scaleParagraph01 = anime.timeline({
  targets: '.fu',
  scale: [1,0],
  opacity: [1,0],
  easing: "easeOutExpo",
...
$('#scroll-anim').on('inview', function(event, isInView) {
  if (isInView) {
    ...
    fadeOutStep02.seek(0)
    fadeOutStep02.seek(0)
    fadeOutStep03.seek(0)
    fadeInParagraph01.seek(0)
    fadeInParagraph02.seek(0)
    fadeInParagraph03.seek(0)
    fadeInParagraph04.seek(0)
